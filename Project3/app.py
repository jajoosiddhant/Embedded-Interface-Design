...
class gui_functionality(Ui_MainWindow):
    ...
    def print_refresh(self):
        ...
        if temperature is None and humidity is None:
            ...
            mylist = {"Alert":"Sensor Offline", "temperature":"None", "humidity":"none", "timestamp":str(current_time)}
        ...
        mylist = {"Alert":"false", "temperature":temperature, "humidity":humidity, "timestamp":str(current_time)}
        JSON_string = json.dumps(mylist)
        MQTTClient.publish("demo/1", JSON_string, 0)
    ...
    def threshold_calc(self, temperature, humidity):
        ...
        if temparray > self.doubleSpinBox_temp.value():
            ...
            mylist = {"Alert":"Temperature", "temperature_alert_level": self.doubleSpinBox_temp.value(), "temperature":temperature, "timestamp":str(current_time)}
            JSON_string = json.dumps(mylist)
            MQTTClient.publish("demo/1", JSON_string, 0)        
        ...
        if humarray > self.doubleSpinBox_hum.value():
            ...
            mylist = {"Alert":"Humidity", "humidity_alert_level": self.doubleSpinBox_hum.value(), "humidity": humidity, "timestamp":str(current_time)}
            JSON_string = json.dumps(mylist)
            MQTTClient.publish("demo/1", JSON_string, 0) 
...
if __name__ == "__main__":
    ...
    MQTTClient = AWSIoTMQTTClient("RaspberryPi-Satya")
    MQTTClient.configureEndpoint("a24t0v877bnidc-ats.iot.us-east-1.amazonaws.com", 8883)
    MQTTClient.configureCredentials("/home/pi/Desktop/Projects/Project3/certs/Amazon_Root_CA_1.pem", \
                                    "/home/pi/Desktop/Projects/Project3/certs/0c3d39d2c7-private.pem.key",\
                                    "/home/pi/Desktop/Projects/Project3/certs/0c3d39d2c7-certificate.pem.crt")
    ...
    MQTTClient.connect()
    MQTTClient.publish("demo/1","Hello From RPI",0)
